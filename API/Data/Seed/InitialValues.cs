...
namespace API.Data.Seed
{
    public static class InitialValues
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Producto>().HasData(new Producto { Id = 2, Nombre = "Arroz con pollo", Detalle = "Platillo tipico de Costa Rica, arroz, pollo demenuzado, frijoles molidos y papas tostadas.", Precio = 4500, Descuento = false, CategoriaId = 3, Imagen = new byte[0x20] });
            ...
            modelBuilder.Entity<Producto>().HasData(new Producto { Id = 4, Nombre = "Freco de Cas", Detalle = "Fresco en agua de Cas", Precio = 2000, Descuento = false, CategoriaId = 2, Imagen = new byte[0x20] });
            modelBuilder.Entity<Producto>().HasData(new Producto { Id = 5, Nombre = "Corte de carne Rib Eye", Detalle = "Corte de carne con pure de papa y esalada", Precio = 14500, Descuento = false, CategoriaId = 3, Imagen = new byte[0x20] });
